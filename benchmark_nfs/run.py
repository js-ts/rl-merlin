...
if __name__ == '__main__':
    ...
    parser.add_argument('--gcs_bucket',
                        type=str,
                        default='gs://renatoleite-criteo-partial',
                        help='GCS bucket')
    ...
    parser.add_argument('--preprocess_image',
                        type=str,
                        default='gcr.io/renatoleite-mldemos/nvt-nvidia-053',
                        help='Training image name')
    parser.add_argument('---data-path',
                        type=str,
                        default='/gcs/renatoleite-criteo-partial/data/',
                        help='Criteo parquet data location')
    parser.add_argument('----out-path',
                        type=str,
                        default='/gcs/renatoleite-criteo-partial/output/',
